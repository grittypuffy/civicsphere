...
export default function ChatPage() {
  ...
  const suggestions = [
    ...
    { label: t("suggestions.trending"), value: "Trending discussions in my area" },
    { label: t("suggestions.accessibility"), value: "Accessibility options available at polling sites" },
  ];
  ...
  return (
    <div className="min-w-dvw max-w-5xl mx-auto flex flex-col flex-1">
      <div className="flex flex-col flex-1 min-h-0 items-center w-full">
              ...
              <div className="flex gap-2 flex-wrap mb-2">
                {suggestions.map((s, idx) => (
                  <Button
                    ...
                    onClick={async () => {
                      await setChatState((prev) => ({ ...prev, input: s.label }));
        ...
        <p className="text-sm opacity-60">Responses are generated by AI and may not be accurate.</p>
      </div>
    </div>
  );
}
