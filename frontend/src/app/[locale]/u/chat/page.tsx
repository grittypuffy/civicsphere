...
import { BotRegular, DeleteFilled, SendFilled } from "@fluentui/react-icons";
...
export default function ChatPage() {
  ...
  async function handleSend(overrideEnglish?: string) {
    ...
    try {
      ...
      const content: { data: { content: string } } = await response.json();
                ...
                <div className="whitespace-pre-wrap wrap-break-word overflow-x-auto">
                  {m.role !== "user" ? (
                    isWaiting ? (
                      ...
                      <div
                        className="prose prose-sm max-w-none wrap-break-word [&>pre]:whitespace-pre-wrap [&>pre]:wrap-break-word space-y-3"
                      >
