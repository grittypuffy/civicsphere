...
async def analyze_post_for_user(profession: str, location: str, title: str, description: str, language: str):
    """
    ...
    TASK:
    1. Summarize the post in **simple, easy-to-understand terms** in this language code's language: {language}
